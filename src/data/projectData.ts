export const projectData = [
  {
    ...
    title: "EcoSphere",
    subtitle:
      "Frontend Project (Production) | Next.js 16, TypeScript, Tailwind CSS, Redux Toolkit, Framer Motion",
    description: {
      main: "Sustainable e-commerce platform combining eco-friendly shopping, environmental awareness, and community engagement.",
    technical: [
  "Built responsive frontend with Next.js 16, TypeScript, and Tailwind CSS.",
  "Integrated RESTful APIs and implemented core features: cart, favorites, authentication, dark/light mode.",
  "Supervised frontend tasks, reviewed code, solved complex issues, and ensured maintainable code."
],

    },
    link: "https://eco-sphere-kappa.vercel.app/en",
    deployed: true,
  },
  {
    id: 2,
  ...
  },
  {
    id: 7,
    title: "Todo",
    subtitle: "Fullstack todo app with modern UI and dark/light mode (Next.js)",
    description: {
