    ...
    <div className=" overflow-hidden flex items-center justify-center p-2">
      ...
      >
        ...
        <div className="animated-border glow-purple">
          <div className="animated-border-inner p-4 sm:p-8">
            {/* Header Section */}
            <div className=" mb-12">
              <motion.div
              ...
              >
                <h2 className="text-4xl sm:text-5xl font-bold bg-gradient-to-br from-[#B19EEF]  to-[#FF9FFC] bg-clip-text text-transparent">
                  Let&apos;s Connect
                </h2>
                <motion.p
                  initial={{ y: -20, opacity: 0 }}
                  ...
                  className="text-[#B19EEF]  text-base"
                >
                  Ready to bring your vision to life? Send me a message!
                </motion.p>
                <div className="h-1 mt-4 w-32  bg-gradient-to-r from-[#B19EEF]  to-[#FF9FFC] rounded-full"></div>
              </motion.div>
            </div>
            ...
            <div className="grid  md:grid-cols-3 md:justify-center md:items-center  gap-6">
            ...
            >
              <button
                ...
                className="my-main-btn group relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg text-nowrap w-full hover:shadow-purple-500/50 flex items-center justify-center"
              >
